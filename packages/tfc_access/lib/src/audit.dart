...
/// most consequential hand-made write in it. The itemKey vocabulary is ten
/// strings:
///
...
/// the same `users` gate as the other eight — not a route.
///
...
/// 2. [allowed] is a **parameter** on all ten. Each auth constructor *is* an
...
/// itemKey vocabulary is a closed set of ten strings the viewer filters on;

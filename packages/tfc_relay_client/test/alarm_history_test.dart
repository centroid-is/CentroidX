    ...
    test('StateManApi did not grow', () {
      ...
      expect(actual, hasLength(20),
          reason: 'the count is written down so a same-size swap cannot slip '
              ...
              'added the `configItems` getter, and 20 since `configHistory` '
              'put `config_change` on the socket — each is an access family '
              'and not another reason to widen this interface casually');

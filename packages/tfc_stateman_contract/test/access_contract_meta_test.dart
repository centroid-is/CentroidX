...
/// gated too.
///
/// 37 since `configItems.replace` — the gateway's second write door, graded
/// by the kind set the caller names rather than by anything in the payload.
...
const _declaredAccessCheckCount = 37;

...
class $$ConfigItemTableTableFilterComposer
    extends Composer<_$AppDatabase, $ConfigItemTableTable> {
...
class $$ConfigItemTableTableTableManager extends RootTableManager<
    ...
    (
      ConfigItemRow,
      BaseReferences<_$AppDatabase, $ConfigItemTableTable, ConfigItemRow>
    ),
    ConfigItemRow,
    PrefetchHooks Function()> {
  $$ConfigItemTableTableTableManager(
      _$AppDatabase db, $ConfigItemTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $$ConfigChangeTableTableFilterComposer
    extends Composer<_$AppDatabase, $ConfigChangeTableTable> {
...
class $$ConfigChangeTableTableTableManager extends RootTableManager<
    ...
    (
      ConfigChangeRow,
      BaseReferences<_$AppDatabase, $ConfigChangeTableTable, ConfigChangeRow>
    ),
    ConfigChangeRow,
    PrefetchHooks Function()> {
  $$ConfigChangeTableTableTableManager(
      _$AppDatabase db, $ConfigChangeTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>

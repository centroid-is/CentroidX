...
/// key's server alias. That case used to be a bare `firstWhere` with no
/// `orElse`, i.e. a `StateError` thrown out of `initState` on any station
/// holding no session for that alias.
Future<Map<String, FieldDescription>> fetchFieldDescriptions(
  ...
  final wrapper = opcUaSessionsOf(stateMan)
